...
import { useEnrollTrainingMutation } from '../../redux/trainees/traineeApiSclice';
...
export default function TrainingForm() {
  const [enrollTrainig, { isLoading }] = useEnrollTrainingMutation();
  ...
  const onSubmit = async (values, { setSubmitting, setErrors }) => {
    try {
      console.log(values);
      const res = await enrollTrainig(values).unwrap();
          ...
          <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
            ...
            >
              <Form>
                ...
                <button className="bg-mainColor flex gap-2 justify-center items-center mt-6 ml-5 text-white active:bg-lightMain font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 ease-linear transition-all duration-150" type="submit">
