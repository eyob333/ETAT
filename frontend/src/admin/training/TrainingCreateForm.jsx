...
export default function TrainingCreateForm() {
    ...
    const isBeforeCurrentDate = (dateTime) => {
        ...
        return new Date(dateTime) < currentDateTime;
    };

    const onSubmit = async (values, { setSubmitting, setErrors }) => {
        console.log(`${new Date().toISOString().slice(0, 16)} current`);
        console.log(`${values.trainingEndDateTime} end`);
        ...
        formData.append('status', status); // Append the string status
        ...
        try {
            ...
            console.log('Create Training Success:', res);
            ...
            setSubmitting(false);
            // Check if error.data exists and has a message
            ...
            <center>
                ...
                <Formik
                    initialValues={{
                        ...
                        trainingEndDateTime: '',
                        trainingPhase: '', // Initialize trainingPhase
                    }}
                    validationSchema={validationSchema}
                    onSubmit={onSubmit} // Use the onSubmit function directly
                >
                    {({ isSubmitting }) => (
                        <Form className="flex flex-col items-start px-8 py-10 w-full">
                            ...
                            <div className="flex mb-6 w-5/6 items-center justify-center">
                                ...
                                >
                                    {isLoading || isSubmitting ? <ButtonLoadingScreen /> : ''}
