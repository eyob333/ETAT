  ...
  return (
    <div className="w-full mx-auto">
      ...
      <div
        ...
        style={{
          backgroundImage:
      "url('https://res.cloudinary.com/deqp41wyr/image/upload/v1750762947/5969687749403461458_1_niptel.jpg')",
        }}
      >
        <div className="flex flex-col min-h-screen bg-black/60 py-12">
          <div className="container flex flex-col flex-1 px-6 mx-auto">
            <div className="flex-1 lg:flex lg:items-center lg:-mx-6 lg:px-32 lg:py-12">
              <div className="text-white lg:w-3/4 lg:mx-6 ">
...
{/* 
                ...
                <div className="mt-6 md:mt-8">
                  <h2 className="text-gray-200 ">Follow us</h2>
                  <div className="flex gap-3 text-lg text-white-600">
        ...
        <Link to=" https://u.wechat.com/kEHi0oDEezhK0FSRZBBl-xE?s=2" className="hover:opacity-60">< AiOutlineWechat /></Link>
                  ...
                  {/* <div className="flex mt-4 -mx-1.5 ">
                    <a className="mx-1.5 text-white transition-colors duration-300 transform hover:text-blue-500" href="https://www.linkedin.com/company/etat-tech/">
